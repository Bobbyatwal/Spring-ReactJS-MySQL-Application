...
import com.bobby.springboot.exception.ResourceNotFoundException;
import com.bobby.springboot.model.Beer;
import com.bobby.springboot.repository.BeerRepository;
...
@PutMapping("/beers/{id}")
	public ResponseEntity<Beer> updateBeer(@PathVariable Integer id, @RequestBody Beer beerDetails){
		...
		beer.setTimeStamp(beerDetails.getTimeStamp());
